...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:ANsW0idDAXIY+mNHzIHxWRfabV2x5LUEEIIWcwsYgB8=",
    ...
    go_repository(
        ...
        sum = "h1:624eIDnkZWNdWbp/N8aDBOUtSY0YW75aJu+vbxnNlkA=",
        version = "v0.2.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3GpI/xR9FoJNTjU6YvCMRbYyEi0dBVY5UtlUTcNRlSA=",
        version = "v0.5.3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:s0SBzK6Zrs4jPtU4A2IEuuVOJCXn6dBZMJ7zz3z/LJQ=",
        version = "v0.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:irj/WzIcgTBay48mSMUYDbKlIzIocXWcuUUsi5qOMOE=",
        version = "v0.2.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jD/b/22R7CSL+F9xNffcexs+wO0Ji/TfwXO/TWck+70=",
        version = "v0.11.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BIul1BPoN1vPAByMh6CeD33NpGjD+PkavmUjTS7uai8=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:phDnQvO3H3hAgaEEQi6yt3LILqIYVXaw05bxzezrEwQ=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ZJK2bHXYUBqObHX+rHLSNrM3M8fmJUlUHrodDPPATmY=",
        version = "v0.1.1",
    )
    go_repository(
